...
print(df['Days to Ship'])

df['Days to Ship'] = df['Shipping Date'].sub(df['Order Date'])
print(df['Days to Ship'])

df['Days to Ship'] = df.apply(lambda x: pd.sub(df['Order Date'],df['Shipping Date']), axis=1)
#df.sub(['Order Date','Shipping Date'], axis=1)
print(df['Days to Ship'])
